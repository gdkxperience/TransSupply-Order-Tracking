...
INSERT INTO orders (id, client_id, internal_ref, status, pickup_city, pickup_country, collection_date, receiver_name, receiver_phone, receiver_city, receiver_country, total_weight_kg, total_price) VALUES
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '22222222-2222-2222-2222-222222222222', '2025Q2-090', 'delivered', 'Eibergen', 'Netherlands', '2025-04-15', 'BPSD Logistics', '+994 12 345 6789', 'Baku', 'Azerbaijan', 120, 115),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '11111111-1111-1111-1111-111111111111', '2025Q2-091', 'delivered', 'Vienna', 'Austria', '2025-04-16', 'AIOC Operations', '+994 12 345 6780', 'Baku', 'Azerbaijan', 36.6, 310),
  ('cccccccc-cccc-cccc-cccc-cccccccccccc', '11111111-1111-1111-1111-111111111111', '2025Q2-092', 'delivered', 'Norderstedt', 'Germany', '2025-04-18', 'AIOC Hamburg Branch', '+994 12 345 6781', 'Baku', 'Azerbaijan', 29, 185),
  ('dddddddd-dddd-dddd-dddd-dddddddddddd', '55555555-5555-5555-5555-555555555555', '2026Q1-001', 'warehouse', 'Vienna', 'Austria', '2026-01-10', 'SCPC Baku Office', '+994 12 345 6790', 'Baku', 'Azerbaijan', 52.47, 310),
  ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '33333333-3333-3333-3333-333333333333', '2026Q1-002', 'warehouse', 'Oskarshamn', 'Sweden', '2026-01-12', 'BTC Tbilisi HQ', '+995 32 123 4568', 'Tbilisi', 'Georgia', 1861, 850),
  ('ffffffff-ffff-ffff-ffff-ffffffffffff', '22222222-2222-2222-2222-222222222222', '2026Q1-021', 'pickup', 'Arras', 'France', '2026-01-28', 'BPSD France Ops', '+994 12 345 6785', 'Baku', 'Azerbaijan', 5741.47, 650),
  ('11111111-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111', '2026Q1-022', 'pickup', 'Zurich', 'Switzerland', '2026-01-29', 'AIOC Zurich', '+994 12 345 6786', 'Baku', 'Azerbaijan', 850, 320);
